...
public class InMemoryCardRepository implements CardRepository {
    ...
    private void initStorage() {
        ...
        card1.setNumber(CardNumberGenerator.generateRandomCardNumber());
        ...
        card2.setNumber(CardNumberGenerator.generateRandomCardNumber());
        ...
        card3.setNumber(CardNumberGenerator.generateRandomCardNumber());
        ...
        card4.setNumber(CardNumberGenerator.generateRandomCardNumber());
        ...
        card5.setNumber(CardNumberGenerator.generateRandomCardNumber());
